...
describe('binarySearchTree', () => {
  ...
  test('should initialize a new binary search tree with a root of null', () => {
    let bst = new BST();
  ...
  test('it should add a child node to the right of the root node', () => {
    ...
    let rootNode = new BSTNode(36);
    bst.insertNode(rootNode);
    let rightNode = new BSTNode(42);
    bst.insertNode(rightNode);
    expect(rootNode.right.data).toEqual(42);
  });
